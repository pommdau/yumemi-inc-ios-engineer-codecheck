...
final class EngineerCodeCheckUITests: XCTestCase {
    ...
    func testSearchResultViewWhenLoading() throws {
        let viewModel: SearchResultViewModel<GitHubAPIClient> = .init(repositories: .loading)
        let view = SearchResultView(viewModel: viewModel)
    ...
    func testSearchResultViewWhenRepositoriesExist() throws {
        let viewModel: SearchResultViewModel<GitHubAPIClient> = .init(repositories: .loaded(Repository.sampleData))
        let view = SearchResultView(viewModel: viewModel)
    ...
    func testSearchResultViewWhenRepositorieyIsEmpty() throws {
        let viewModel: SearchResultViewModel<GitHubAPIClient> = .init(repositories: .loaded([]))
        let view = SearchResultView(viewModel: viewModel)
